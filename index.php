...
<title>QUIZ || QUIZ TIME || TECHIES </title>
...
if (z == null || z == "") {alert("college must be filled out.");
return false;
}
...
<div class="row">
<div class="col-lg-6">
<span class="logo">QUIZ || TECHIES</span></div>
...
<div class="col-md-3 box">
<a href="admin.php" data-toggle="modal" data-target="#login">Admin Login</a></div>
<div class="col-md-3 box">
